    ...
    fetch("https://allarassemjonathan.github.io/api/file.json")
        ...
        .then(pieceList => {
            ...
            for (const key in pieceList) {
                ...
                pieceLi.setAttribute('class', 'studypadding');
                ...
                pieceDiv.setAttribute('class', 'study-js');
                ...
                pieceButton.setAttribute('class', "study btn btn-dark");
...
function renderPiece(i) {
    ...
    if (buttonClicked.innerText == "Maximize") {
        ...
        if (i.year[0] === i.year[1]) {
            pieceDate.innerText = Math.abs(i.year[0]);
        }
        else {
